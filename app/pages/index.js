...
export default function Home(){
  ...
  //the total number of tokens that have been minted till now 
  const [tokensMinted,setTokensMinted] = useState(zero);
  //gets the owner of the contract through the signed address
  const [isOwner,setIsOwner] = useState(false);
  //create a reference to the web3 modal(to connect to metamask) persists as long as the page is open
  ...
  return (
    <div>
      <Head>
        <title>Crypto ERC20</title>
        <meta name="description" content="" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to CryptoDev ERC20 Offering!</h1>
          <div className={styles.description}>
            You can claim or mint Crypto ERC20 tokens here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
                You have minted {utils.formatEther(balanceOfCryptoDevs)} Crypto
                Dev Tokens
              </div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
